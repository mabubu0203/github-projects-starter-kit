...
>
> <img src="assets/images/quickstart-run-workflow.png" alt="ワークフロー実行画面" width="50%">
>
> <img src="assets/images/quickstart-run-workflow-detail.png" alt="ワークフロー実行詳細画面" width="50%">
